...
const navigation = {
    social: [
        {
            name: "contactUs",
            href: "https://faradars.org/contact-us",
...
const Social = () => {
    ...
    return (
        <div className="flex justify-center bg-gray-700 h-[60px] bg-gradient-to-l from-[#734ac3] to-[#6753c9]">
                ...
                <div className="flex px-4 py-3  justify-center">
                    {navigation.social.map((item) => (
                        ...
                        >
                            ...
                            <item.icon className="h-9 w-9 opacity-75 hover:opacity-100 " aria-hidden="true" />
                        </a>
                    ))}
                </div>
            </div>
