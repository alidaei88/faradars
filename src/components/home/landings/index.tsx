  ...
  return (
    <>
          ...
          <div className=" text-center bg-[#181818] pb-16">
            <h1 className='text-white text-[32px]'> مسیرهای یادگیری و مجموعه‌های آموزشی </h1>
            <h4 className='text-white text-[14px]'>هدف خود را انتخاب کنید و با مجموعه‌های آموزشی زیر به آن برسید.</h4> 
          </div>  
          <div className="bg-[#181818] pb-12 flex flex-wrap">
              <div className='container mx-auto grid lg:grid-cols-2 md:grid-cols-1 xsm:grid-cols-1 gap-2 gap-y-4'>
              {
                    ...
                    <div key={item.id} className="bg-white w-[90%] p-2 flex  ">
                        ...
                        <div className='w-2/3 flex flex-col justify-evenly '>
                            ...
                            <div className='flex flex-row justify-evenly text-sm text-[#777575]'>
                                  <span className='text-sm text-[#777575]'>{ item.count_product }آموزش </span>
                                  |
                                  <span className='text-sm text-[#777575]'>{ item.total_time } ساعت</span>
                                  |
                                  <span className='text-sm text-[#777575]'>{ item.count_student } دانشجو</span>
                            </div>
                        </div>
                    </div>   
                  )
